...
export function getSelectedProjectPath() { return selectedProjectPath; }
...
export function selectProject(projectPath) {
...
export function sessionsForProject(projectPath) {
  return [...sessions.entries()].filter(([, s]) => s.projectPath === projectPath);
}

export function countSessionsForProject(projectPath) {
